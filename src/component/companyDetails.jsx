  ...
  return (
    <div className="flex flex-col w-full relative" id="HomeDiv">
      ...
      <div className="flex w-full  justify-center items-center align-middle z-10 mb-10 ">
        <div id="middle-section" className="overflow-y-scroll flex flex-col border-2 border-gray-200 rounded shadow-md  w-4/5 my-4 bg-white ">
          ...
          <div class=" min-h-auto py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
            ...
            <div className=" flex flex-wrap justify-center  gap-8 lg:gap-16">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                <div class="flex sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
